...
public static class EventsManager
{
        ...
        where MessageType : class
    {
        ...
        {
            handler = EventsManager.RegisterInternal<YieldListener<MessageType>, MessageType>(
        ...
        public void Dispose()
        {
            if (handler != null)
            {
                EventsManager.UnlistenHandler(typeof(MessageType), handler);
                handler = null;
            }
        }
    ...
    private sealed class EventBetterWorker : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            EventsManager.RemoveUnusedHandlers();
        }
    }
    ...
    {
        return EventsManager.UnregisterInternal(messageType, handler, (eventEntry, index, _handler) => eventEntry.handlers[index] == _handler);
    }
